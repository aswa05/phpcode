...
<div class="row">
  ...
  <div class="main">
  <form method="get" action="deleteProductSuccess.php" ><br><br>
  
  <center><h2>Please fill below details to delete a new Product</h2><br><br>
...
Click here to delete the Product</button></tr></center>
