...
<div class="row">
  ...
  <div class="main">
	...
	<form method="get" action="modifySuccess.php" >
 ...
 <label for="hasta" style="float: right;"><sub>Date:</sub></label><br><br>
 	<br><label for="billNo">Bill No:</label>
...
<table  id="myTable" style="width:100%  ">
  ...
  <td><input type="number" name="quantity1"  style="width:50px; height:20px;" value="<?php if(isset($_GET['quantity1'])){	echo $_GET['quantity1']; }else {echo "";}?>" ></td>
  <td><input type="text" name="price1" style="width:100px; height:25px;" value="<?php echo $price[1]; ?>"></td> </tr>
  ...
  <td><input type="number" name="quantity2" style="width:50px; height:20px;" value="<?php if(isset($_GET['quantity2'])){	echo $_GET['quantity2']; }else {echo "";}?>" ></td>
  <td><input type="text" name="price2" style="width:100px; height:25px;" value="<?php echo $price[2]; ?>"></td>  </tr>
  ...
  <td><input type="number" name="quantity3" style="width:50px; height:20px;" value="<?php if(isset($_GET['quantity3'])){	echo $_GET['quantity3']; }else {echo "";}?>"></td>
  <td><input type="text" name="price3" style="width:100px; height:25px;" value="<?php echo $price[3]; ?>"></td>  </tr>
  ...
  <td><input type="number" name="quantity4" style="width:50px; height:20px;" value="<?php if(isset($_GET['quantity4'])){	echo $_GET['quantity4']; }else {echo "";}?>" ></td>
  <td><input type="text" name="price4" style="width:100px; height:25px;" value="<?php echo $price[4]; ?>"></td>  </tr>
  ...
  <td><input type="number" name="quantity5" style="width:50px; height:20px;" value="<?php if(isset($_GET['quantity5'])){	echo $_GET['quantity5']; }else {echo "";}?>"></td>
  <td><input type="text" name="price5" style="width:100px; height:25px;" value="<?php echo $price[5]; ?>"></td>  </tr>
  ...
  <tr><td>SGST</td><td><input type="text" name="sgst" style="width:100px; height:25px;" value="<?php echo round($gst,2); ?>"></td></tr>
  <tr><td>CGST</td><td><input type="text" name="cgst" style="width:100px; height:25px;" value="<?php echo round($gst,2); ?>"></td></tr>
