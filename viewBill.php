...
<div class="row">
  ...
  <div class="main">
	...
	<form method="get" action="viewBillStatus.php" >
	<table><tr>
  <td><label for="fromDate">From Date:</label>
  <input type="date" name="fromDate" ></td>
  <td><label for="toDate">From Date:</label>
  <input type="date" name="toDate" ></td></tr>
  <tr><td colspan="2">GST Percentage &nbsp;<select name="gstPercentage" style=" width:200px; height:30px;"><option value="5">5</option><option value="12">12</option><option value="18">18</option></select></td></tr>
  <tr ><td colspan="2"><button type="submit" name="button1">	
Click here to view the bill details</button></td></tr></table>
